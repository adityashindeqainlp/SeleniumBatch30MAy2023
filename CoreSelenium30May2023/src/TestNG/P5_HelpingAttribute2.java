 ...
 **/
public class P5_HelpingAttribute2 {
	...
	public void urlValidation() {
		...
		sa = new SoftAssert();
		sa.assertEquals(urlFromBuild, "https://opensource-demo.orangehrmlive.com/web/index.php/auth/login123");
		sa.assertAll();
	}
	...
	public void titleValidation() {
		...
		sa = new SoftAssert();
		sa.assertEquals(titleFromBuild, "OrangeHRM123");
		sa.assertAll();
	}
